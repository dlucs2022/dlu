<template>
    <el-dialog
        ...
        <div class="hello">
            <uploader :key="uploader_key" :options="options" ref="uploader"
                    :autoStart="false"  @complete="complete" @file-complete="rootComplete"
...
export default {
    ...
    data() {
        return {
            ...
            folderName:'',
            options: {
                target: 'http://localhost:8003/dlu/file/uploadCategory',//SpringBoot后台接收文件夹数据的接口
                testChunks: false  ,   //是否分片-不分片,
                withCredentials:true,       //携带跨域信息
                simultaneousUploads:1,
                query:
                    function(file, res, status) {
